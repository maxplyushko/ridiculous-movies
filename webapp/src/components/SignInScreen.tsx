    ...
    <div className="auth-screen">
      ...
      <div className="auth-screen__body">
        ...
        <div className="auth-screen__card">
          ...
          {isTelegramMiniApp() ? (
            googleTgState === "waiting" ? (
              <p className="auth-screen__waiting">
                Browser opened. Complete sign-in, then tap the link Telegram sends you to return.
              </p>
            ) : (
              <button className="auth-screen__google-tg-btn" onClick={handleTgGoogle}>
